...

{
    ...
    {
        val view = LayoutInflater.from(mContext).inflate(R.layout.notifiicatio_item_layout,parent,false)
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int)
    {
        ...
        {
            holder.text.text=notification.getText().replace("...commented:","...comment: ")
        }
        else
        {
    ...
    inner class ViewHolder(@NonNull itemView :View) :RecyclerView.ViewHolder(itemView)
    {
        ...
        var text :TextView
        init {
            postImage = itemView.findViewById(R.id.notification_post_imange)
            profileImage = itemView.findViewById(R.id.thongbao_profile_image)
            userName = itemView.findViewById(R.id.uername_noti)
            text = itemView.findViewById(R.id.commet_noti)
        }
    }
        ...
        userRef.addValueEventListener(object : ValueEventListener {
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                if (snapshot.exists()){
                    ...
                    Picasso.get().load(user!!.getImage()).placeholder(R.drawable.profile1).into(imageView)
        ...
        postRef.addValueEventListener(object : ValueEventListener
        {
            override fun onDataChange(p0: DataSnapshot)
            {
                if (p0.exists())
                {
                    ...
                    Picasso.get().load(post!!.getPostimage()).placeholder(R.drawable.profile1).into(imageView)
